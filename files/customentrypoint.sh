...
echo "You can add the parameters in the CMD part of your docker call. Just like the README on the github project https://github.com/adrianogalindo/soapui-docker.git"


echo "Lets Replace the Log Level"

sed -i "s|<<REPLACE_LOG_LEVEL>>|${LOG_LEVEL-DEBUG}|g" /usr/local/SmartBear/SoapUI-5.7.0/bin/soapui-log4j.xml
